...
\centering
    % Draw the main box
    \node[draw, minimum width=3cm, minimum height=1.5cm] (box) at (0,0) {\fontsize{16}{18} \selectfont $\frac{k_p}{\tau_ps + 1}$};
    ...
    \node[anchor=east] at (-2,0.3) {A/s};
    
    % Label the output arrow
    \node[anchor=west] at (2,0.3) {$k_pA(1-e^{\frac{-t}{\tau}})$};
\end{tikzpicture}
